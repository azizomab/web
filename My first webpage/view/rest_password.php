...
$userc=new userc() ; 
$usr=$userc->showuser($_SESSION['iduser']);
$user = new user(
    $usr['iduser'],
    $usr['username'],
    password_hash($_POST['password'], PASSWORD_DEFAULT),
    $usr['email'],
    new DateTime($usr['dob'])
);
$userc->updateuser($user,$usr['iduser']) ; 
} 
else 
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>rest your password!</strong></h3>
            
        </div>
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="" method="POST" onsubmit="return checkpass(); "   class="mbr-form form-with-styler mx-auto" data-form-title="Form Name">
                    <div class="dragArea row">
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="password">
                            <input type="text" name="password" placeholder="password" data-form-field="password" class="form-control" value="" id="password">
                            <span id="password-error"></span>
                        </div> 
                          <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="confirm_password">
                            <input type="confirm_password" name="confirm_password" placeholder="confirm_password" data-form-field="confirm_password" class="form-control" value="" id="confirm_password">
                            <span id="confirm_password-error"></span>
                        </div>                      
...
<section data-bs-version="5.1" class="footer3 cid-tAAP8ZL6Qh" once="footers" id="footer3-s">
  ...
  <script>
    function checkpass(){
       ...
       document.getElementById("confirm_password-error").innerHTML = confirmPasswordError;
       document.getElementById("confirm_password-error").style.color = "red";
       test=false;
     } else {
